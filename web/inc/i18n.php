...
$domain = "skynetcp";
$localedir = "/usr/local/skynet/web/locale";
...
function get_email_template($file, $language) {
	if (
		file_exists(
			$_SERVER["skynet"] . "/data/templates/email/" . $language . "/" . $file . ".html",
		)
	) {
	...
	if (file_exists($_SERVER["skynet"] . "/data/templates/email/" . $file . ".html")) {
		return file_get_contents($_SERVER["skynet"] . "/data/templates/email/" . $file . ".html");
	}
	return false;
}
