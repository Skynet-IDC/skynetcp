...
<head>
	...
	<?php require $_SERVER["skynet"] . "/web/templates/includes/title.php"; ?>
	<?php require $_SERVER["skynet"] . "/web/templates/includes/css.php"; ?>
	<?php require $_SERVER["skynet"] . "/web/templates/includes/js.php"; ?>
</head>
