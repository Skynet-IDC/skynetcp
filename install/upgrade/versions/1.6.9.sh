...
if [ -f "$SKYNET/data/api/sync-dns-cluster" ]; then
	rm $SKYNET/data/api/sync-dns-cluster
	cp $SKYNET/install/deb/api/sync-dns-cluster $SKYNET/data/api/sync-dns-cluster
fi
