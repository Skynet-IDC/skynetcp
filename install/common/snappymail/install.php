...
\SnappyMail\Repository::installPackage("plugin", "change-password-skynet");
		...
		json_encode(
			[
				"plugin" => [
					...
					"driver_skynet_enabled" => true,
					"driver_skynet_allowed_emails" => "*",
					"skynet_host" => gethostname(),
					"skynet_port" => $argv[4], // $BACKEND_PORT
				],
			],
			JSON_PRETTY_PRINT,
		),
...
$sFile = APP_PRIVATE_DATA . "domains/skynet.json";
if (!file_exists($sFile)) {
