...
export default defineConfig({
	...
	themeConfig: {
		...
		socialLinks: [
			{ icon: 'github', link: 'https://github.com/skynetcp/skynetcp' },
			{ icon: 'twitter', link: 'https://twitter.com/skynetPanel' },
			{ icon: 'facebook', link: 'https://www.facebook.com/skynetcp' },
		],
		...
		editLink: {
			pattern: 'https://github.com/skynetcp/skynetcp/edit/main/docs/:path',
			text: 'Edit this page on GitHub',
		},

		footer: {
			message: 'Released under the GPLv3 License.',
			copyright: 'Copyright © 2019-present skynet Control Panel',
		},
...
function nav() {
	return [
		...
		{ text: 'Team', link: '/team' },
		{ text: 'Demo', link: 'https://demo.skynetcp.com:8083/' },
		{ text: 'Forum', link: 'https://forum.skynetcp.com/' },
		{ text: 'Donate', link: '/donate' },
		{
			...
			items: [
				{
					text: 'Changelog',
					link: 'https://github.com/skynetcp/skynetcp/blob/main/CHANGELOG.md',
				},
				{
					text: 'Contributing',
					link: 'https://github.com/skynetcp/skynetcp/blob/main/CONTRIBUTING.md',
				},
				{
					text: 'Security policy',
					link: 'https://github.com/skynetcp/skynetcp/blob/main/SECURITY.md',
				},
			],
		},
	];
...
function sidebarDocs() {
	return [
		...
		},
		{
			...
			collapsed: false,
			items: [
				{ text: 'skynet Nginx Cache', link: '/docs/community/skynet-nginx-cache' },
				{
					text: 'Ioncube installer for skynet',
					link: '/docs/community/ioncube-skynet-installer',
				},
