...
- **default-nomail**: Standard DNS template. Suitable for most usecases when you don’t want to host mail on skynet.
...
This date is not used by skynet, but can be used as a reminder.
